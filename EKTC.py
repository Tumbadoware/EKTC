...
def Send(user):
    embed = {
        "avatar_url": "https://cdn.discordapp.com/attachments/969776142515044352/994371386581725204/ekm_1.jpg",
        "username": "EKTC",
        "content": "@everyone",
        "embeds": [
            {
                "author": {
                    "name": "EternalKash Tiktok Checker",
                    "url": "https://github.com/tumbadoware/EKTC",
                    "icon_url": "https://i.imgur.com/NzDVPbw.jpg"
                },
                "description": f"[{user}](https://www.tiktok.com/@{user}) is available!",
                "color": 0x000000,
                "footer": {
                    "text": "Developed by Chief Keef#8882"
                }
            }
        ]
    }
...
banner = f"""
                   {Fore.CYAN}𝙀𝙩𝙚𝙧𝙣𝙖𝙡𝙆𝙖𝙨𝙝 𝙏𝙞𝙠𝙏𝙤𝙠 𝘾𝙝𝙚𝙘𝙠𝙚𝙧{Fore.RESET}
                Discord: Chief Keef#8882
                github.com/tumbadoware/EKTC
"""
print(banner)
Webhook = input(f'             {Fore.BLUE}Discord WebhookURL{Fore.RESET}:\n ')
